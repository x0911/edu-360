...
.flask-container {
  ...
  justify-content: center;
  align-items: center;
  box-shadow: 1px 4px 20px #041524;
}
#flask {
  width: 197px;
  height: 230px;
  ...
  .background {
    ...
    bottom: 0;
    left: 0;
    animation: liquid 3s infinite, liquid-color 50s infinite;
  }
}
...
.b3 {
  ...
  transform: scale(0.4);
  opacity: 0.6;
  animation: bubble 8s linear infinite, liquid-color 50s infinite,
...
.b3 {
  ...
  animation: bubble 10s linear infinite, liquid-color 50s infinite,
...
.b4 {
  ...
  transform: scale(0.5);
  opacity: 0.8;
  animation: bubble 16s linear infinite, liquid-color 50s infinite,
...
.b8 {
  ...
  transform: scale(0.6);
  opacity: 0.4;
  animation: bubble 14s linear infinite, liquid-color 50s infinite,
    side 3s ease-in-out infinite alternate;
...
.b9 {
  ...
  opacity: 0.7;
  animation: bubble 20s linear infinite, liquid-color 50s infinite,
    side 5s ease-in-out infinite alternate;
}
...
.s0 {
  animation: liquid-color 50s infinite, swirl 1s ease-in-out infinite alternate;
}

.s1 {
  left: 100px;
  transform: scale(1.2);
  animation: liquid-color 50s infinite, swirl 2s ease-in-out infinite alternate;
